 ...
 */
static void __list_add(struct list_head *newhead,
 ...
 */
static   void list_add(struct list_head *newhead, struct list_head *head)
{
 ...
 */
static   void list_add_tail(struct list_head *newhead, struct list_head *head)
{
